...
const serializeProperty = (property, currentUserId = null) => {
  ...
  return {
    ...
    administrationIncluded: property.administrationIncluded,
    ...
    equippedKitchen: property.equippedKitchen,
    laundryArea: property.laundryArea,
    elevator: property.elevator,
    doorman: property.doorman,
    ...
    contactRelationship: property.contactRelationship,
    contactHours: property.contactHours,
    contactPreference: property.contactPreference,
    publishingAuthorization: property.publishingAuthorization,
    acceptsStudents: property.acceptsStudents,
    acceptsFamilies: property.acceptsFamilies,
    acceptsCosigner: property.acceptsCosigner,
    requiresRentalStudy: property.requiresRentalStudy,
    visitsAllowed: property.visitsAllowed,
